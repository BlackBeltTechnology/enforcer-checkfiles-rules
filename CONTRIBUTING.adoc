...
This project follows a standard Java project structure, governed by Maven, with Maven submodules.
...
You can file new issues by filling out our https://github.com/BlackBeltTechnology/enforcer-checkfiles-rules/issues/new/choose[issue form].
